...
export class Navbar extends React.Component {
    render() {
        return (
            <nav className="navbar navbar-expand-lg navbar-dark py-4" style={{"backgroundColor":"none"}}>
                <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarColor01" aria-controls="navbarColor01" aria-expanded="false" aria-label="Toggle navigation">
                    <span className="navbar-toggler-icon"></span>
                </button>
                <div className="collapse navbar-collapse d-flex justify-content-center col-12" id="navbarColor01">
                    <ul className="navbar-nav d-flex justify-content-between col-11 " style={{flex: 1}} >
                        <li className="nav-item">
                            <ul className="navbar-nav text-white">
                                <li><Link className="nav-link text-white border-bottom" to="/">About <span className="sr-only">(current)</span></Link></li>
